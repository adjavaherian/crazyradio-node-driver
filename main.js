var crazyradio = require('./crazyradio');
var config = {
    channel: 80,
    dataRate: '250K'
};
...
//(function() {
//  console.debug('main loader');
//  Crazyradio.open(function(state) {
//    console.log("Crazyradio opened: " + state);
//    if (state === true) {
//      Crazyradio.setChannel(80, function(state) {
//        console.log('setChannel', state);
//        Crazyradio.setDatarate('250Kbps', function(state) {
//          console.log('setDatarate', state);
//
//          var pitch = 0,
//              roll  = 0,
//              yaw   = 0,
...
//            console.debug('sendPacket cb', state, data);
//          });
//
//
//
